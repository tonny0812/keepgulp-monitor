...
//    private  CmdbResourceServerService service;
    ...
    private  ResourceServerEntity temp = new ResourceServerEntity();

//    public Ping(ArrayList<String> ip, CmdbResourceServerService service, ResourceServerEntity entity){
//        this.ip = ip;
